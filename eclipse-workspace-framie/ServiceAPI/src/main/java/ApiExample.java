...
public class ApiExample 
{
        ...
        throws GeneralSecurityException, IOException, GoogleJsonResponseException 
    {
        ...
        findChannelSections(youtubeService, YOUTUBE_FREE_MOVIES_CHANNEL);
        findChannels(youtubeService, YOUTUBE_FREE_MOVIES_CHANNEL);
        printVideosByChannelId(youtubeService, YOUTUBE_FREE_MOVIES_CHANNEL);
    }
